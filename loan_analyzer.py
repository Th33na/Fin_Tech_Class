...
print(f"Remaining Months on the loan is {remaining_months} months.")
...
if present_value >= future_value:
    print(f"Present value of the loan ({present_value:.2f}) is worth at least the cost to buy it.")
else:
    print(f"Present value of the loan ({present_value:.2f}) is too expensive and not worth the price.")
...
for loan_data in loans:
    if loan_data.get("loan_price") <= 500:
        inexpensive_loans.append(loan_data)

# @TODO: Print the `inexpensive_loans` list
# YOUR CODE HERE!
print("Here are the inexpensive loans:")
for idx, loan_data in enumerate(inexpensive_loans):
    print(f" Loan {idx + 1}: {loan_data}")
print("-" * 20)
...
print(f"File {output_path} is ready for review.")
print("-" * 20)